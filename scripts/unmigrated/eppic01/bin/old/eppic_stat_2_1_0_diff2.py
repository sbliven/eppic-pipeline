...
import commands
def get_stat(dbname,total,new,removed,uniprot,rsyncfile,dd):
	updated=total-new
	...
	cmd="find  /data/dbs/pdb/data/structures/all/mmCIF/ -name *.cif.gz |  wc -l"
...
#	Taxonomy=commands.getoutput(cmd).split("\n")
	...
	fo=open("/home/eppicweb/topup/statistics_%s.html"%(dd),'w')
...
if __name__=="__main__":
	...
	dd=sys.argv[7]
	get_stat(dbname,total,new,removed,uniprot,rsyncfile,dd)	
